...
// void dgemm_ref_working(const int lda, const int M, const int N, const int K,
//                const double *A, const double *B, double *C)
// {
//     // int i;
//     for (int j = 0; j < N; ++j) {
...
//             for (; i < M - 4; i+=4) {
//                 C[j * lda + i] += A[k * M + i] * b;
//                 C[j * lda + i + 1] += A[k * M + i + 1] * b;
//                 C[j * lda + i + 2] += A[k * M + i + 2] * b;
//                 C[j * lda + i + 3] += A[k * M + i + 3] * b; 
//             }
//             for (; i < M; ++i)
//             {
//                 C[j * lda + i] += A[k * M + i] * b;
              ...
              double *A_buffer, double *B_buffer, double *C_buffer)
{
    ...
    // simd_dgemm2(lda, i_block_size, j_block_size, k_block_size,
    //            A_buffer, B_buffer, C + i + j * lda);
